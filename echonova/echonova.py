"""
EchoNova — Desktop Voice Assistant
A Python-based voice assistant that can perform daily tasks
...
def speak(audio) -> None:
    """Makes EchoNova speak the given text."""
    engine.say(audio)
    engine.runAndWait()
...
def load_name() -> str:
    """Loads the assistant name from file, defaults to EchoNova."""
    try:
